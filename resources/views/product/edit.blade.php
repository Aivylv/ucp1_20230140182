                    ...
                    <form action="{{ route('product.update', $product) }}" method="POST" class="space-y-5">
                        ...
                        <div class="mt-4">
                            ...
                            <select id="kategori_id" name="kategori_id" required
                                    class="w-full px-4 py-2.5 rounded-lg border text-sm {{ $errors->has('kategori_id') ? 'border-red-400 bg-red-50 dark:bg-red-900/20' : 'border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700' }} text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition">
                                <option value="">-- Select Kategori --</option>
                                @foreach ($kategoris as $kategori)
                                    {{-- Otomatis memilih kategori yang tersimpan di database menggunakan $product->kategori_id --}}
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" id="quantity" name="quantity" value="{{ old('quantity', $product->quantity) }}" placeholder="0" min="0"
